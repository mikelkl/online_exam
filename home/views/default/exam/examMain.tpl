...
<head>
    ...
    <script>
        var intDiff = parseInt(<{$duration}>) * 3600;//倒计时总秒数量
                                            ...
                                            <div style="padding-bottom: 0px">
                                                <table class="table table-striped table-bordered table-hover" style="border;width: 755px;text-align:center;margin-left:auto;margin-right:auto">
                                                    <thead style="border: 0px solid #F0F0F0; background-color:#F0F0F0;">
                                                        <tr>
                                                            <th>
                                                                <{$smarty.section.list.index_next}>
                                                                    、
                                                                    <{$data[list].tq_content}></th>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <textarea name="<{$data[list].tq_id}>" id="contents" style="width: 1080px; border-bottom-width:
