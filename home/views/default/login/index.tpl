...
<head>
	...
	<script src="<{$res}>/js/stuCheck.js"></script>
	<script src="<{$res}>/js/tecCheck.js"></script>
	<script src="<{$res}>/js/loginCheck.js"></script>
</head>
       ...
       aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="stuRegister" role="form" action="<{$app}>
       ...
       aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="tchRegister" role="form" action="<{$app}>
		...
		<div class="jumbotron">
			<div class="container">
				...
				<h1>你OUT了!</h1>
				<p>
					<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal1">学生注册  &raquo;</button>
					<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">教师注册  &raquo;</button>
				</p>
			</div>
		</div>
		...
		<!-- /container -->
		<input type="hidden" value="<{$app}>" id="ajaxurl" /></body>
	</html>