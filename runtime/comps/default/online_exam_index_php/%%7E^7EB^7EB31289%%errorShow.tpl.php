<?php /* Smarty version 2.6.18, created on 2015-06-16 16:00:26
         compiled from exam/errorShow.tpl */ ?>
<!doctype html>
...
?>
			<p style="color: brown">
				错题<?php echo $this->_sections['list']['index_next']; ?>
：<?php echo $this->_tpl_vars['data'][$this->_sections['list']['index']]['tq_content']; ?>

			</p>
			<p style="color: blue">
				你的答案：<?php echo $this->_tpl_vars['data'][$this->_sections['list']['index']]['mine']; ?>

			</p>
			<p style="color: black">
				参考答案：<?php echo $this->_tpl_vars['data'][$this->_sections['list']['index']]['answer']; ?>
