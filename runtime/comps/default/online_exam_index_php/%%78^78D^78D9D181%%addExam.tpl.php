<?php /* Smarty version 2.6.18, created on 2015-06-16 15:12:56
         compiled from exam/addExam.tpl */ ?>
...
$this->_sections['list']['loop'] = is_array($_loop=$this->_tpl_vars['item']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                            ...
                            <?php if ($this->_tpl_vars['item'][$this->_sections['list']['index']]['ib_name'] == "选择题"): ?>
                            ...
                            <?php endif; ?>
                            <?php echo $this->_tpl_vars['item'][$this->_sections['list']['index']]['ib_name']; ?>
...
/exam/addTq/course_id/<?php echo $this->_tpl_vars['course_id']; ?>
" method="post">
                            <div class="input-group">
...
$this->_sections['list']['last']       = ($this->_sections['list']['iteration'] == $this->_sections['list']['total']);
?>
                                                <option value="<?php echo $this->_tpl_vars['item'][$this->_sections['list']['index']]['ib_id']; ?>
"><?php echo $this->_tpl_vars['item'][$this->_sections['list']['index']]['ib_name']; ?>
</option>
                                            <?php endfor; endif; ?>
                                        </select>
                        ...
                        <input type="hidden" value="<?php echo $this->_tpl_vars['course_id']; ?>
" name="course_id" />
                        <div class="modal-footer">
